...
export function ItemInspector({
  ...
  return (
    <aside
      ...
      className="mt-6 flex max-h-[calc(100vh-3.5rem)] flex-col overflow-hidden rounded-lg border border-hair bg-surface outline-none lg:mt-0 lg:max-h-full lg:w-[var(--rail)] lg:shrink-0 lg:self-start"
    >
      {/* header */}
