...
const EN = {
  ...
  "write.line": "{file} · line {line}",
  "write.reversible": "Edits {file}. Reversible — an auto-snapshot is taken first.",
  ...
  "remove.prune": "Also prunes {count} orphaned [[skills.config]] entries (codex).",
  "remove.pruneNone": "No config entries reference it — only the folder is removed.",
...
const ZH: Record<StringKey, string> = {
  ...
  "write.line": "{file} · 第 {line} 行",
  "write.reversible": "将修改 {file}。可回滚 —— 写入前会自动快照。",
  "write.confirm": "确认并应用",
  "write.cancel": "取消",
  "write.dismiss": "关闭",
  "write.done": "已应用。",
  ...
  "remove.prune": "将一并清理 {count} 条孤立的 [[skills.config]] 条目（codex）。",
  "remove.pruneNone": "没有引用它的 config 条目 —— 仅删除该目录。",
