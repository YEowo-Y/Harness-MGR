...
test('integration: mixed file+external missing facts → both checks fire; registry is [1,2,3,5,18,6,7,8,9,10,11,12,22,23,13,14,16,20,21,25,17,24,26,27,4,15,19]', () => {
  const r = runDoctor({
    hookFacts: [
