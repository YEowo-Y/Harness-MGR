...
test('aggregate: all three checks fire together; report is passive with per-check summaries', () => {
  ...
  assert.deepEqual(r.checks.map((c) => [c.id, c.findings]), [[1, 0], [2, 0], [3, 0], [5, 0], [18, 0], [6, 1], [7, 1], [8, 0], [9, 0], [10, 0], [11, 1], [12, 0], [22, 0], [23, 0], [13, 0], [14, 0], [16, 0], [20, 0], [21, 0], [25, 0], [17, 0], [24, 0], [4, 0], [15, 0]]);
