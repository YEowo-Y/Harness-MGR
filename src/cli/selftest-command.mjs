 ...
 *
 * Handles `selftest` (smoke + rigorous gates) and the new `selftest --release-gate`
 * (the 6-step P3 release gate). Both dispatch paths return the standard
 ...
 *
 * Flags:
 *   --release-gate  run the 6-step release gate instead of the smoke path
